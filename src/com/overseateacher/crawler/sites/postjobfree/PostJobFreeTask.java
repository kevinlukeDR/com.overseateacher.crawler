 ...
 */
public class PostJobFreeTask  implements ICrawlerTask {

    public final String taskname = "PostJobFree";
     ...
     */
        controller.start(PostJobFreeCrawler.class, numberOfCrawlers);
