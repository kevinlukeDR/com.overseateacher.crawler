 ...
 */
public class TeachWebCrawler implements Runnable {

    protected static final Logger logger = LoggerFactory.getLogger(TeachWebCrawler.class);
     ...
     */
    protected TeachCrawlerController myController;
     ...
     */
    private TeachPageFetcher pageFetcher;
     ...
     */
    private TeachRobotstxtServer robotstxtServer;
     ...
     */
    public void init(int id, TeachCrawlerController crawlController) {
        this.myId = id;
    ...
    public TeachCrawlerController getMyController() {
        return myController;
    }
