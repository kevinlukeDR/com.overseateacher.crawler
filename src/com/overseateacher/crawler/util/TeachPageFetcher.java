 ...
 */
public class TeachPageFetcher extends Configurable {
    protected static final Logger logger = LoggerFactory.getLogger(TeachPageFetcher.class);
    ...
    public TeachPageFetcher(CrawlConfig config) {
        super(config);
    ...
    private void doAuthetication(List<AuthInfo> authInfos) {
        for (AuthInfo authInfo : authInfos) {
            if (authInfo.getAuthenticationType() ==
                ...
                doFormLogin((TeachFormAuthInfo) authInfo);
            }
        }
    }
     ...
     */
    private void doFormLogin(TeachFormAuthInfo authInfo) {
        ...
        List<NameValuePair> formParams = authInfo.getParameterPairs();
